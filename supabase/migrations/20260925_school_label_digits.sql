-- Novas etiquetas de turma usam somente codigos numericos de ate 5 digitos.
...
begin
  ...
  if cleaned !~ '^[0-9]{0,5}$' then
    raise exception 'Turma deve ter no máximo 5 dígitos.' using errcode='22023';
  end if;
